...
public class SMSService {
	 ...
	 * @param logUser
	 */
	private void saveSentHistory(String phone, String shortMessage,
			String logUser) {
	...
	public static void main(String[] args) {
		...
		// endIndex = total;
		// }
		// String perMsg = msg.substring(beginIndex,endIndex) +
		// "("+i+"/"+page+")";
		// System.out.println(perMsg);
		// }

		// String result =
		// "num=0&success=&faile=13804802181&err=该企业用户余额不足&errid=6013";
		// String err =
		// result.substring(result.indexOf("err")+4,result.indexOf("errid")-1);
