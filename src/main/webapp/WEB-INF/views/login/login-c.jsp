			...
			<div class="Right">
				...
				<div class="Login">
					<div class="Login_Head">
						<div class="User_Login" title="用户登录" style="background:url(${contextPath}/images/login/User_Login_Company.jpg) no-repeat;"></div>
							...
							<div class="User">
								<div class="UserName">
									...
									<div class="Name_print">
										...
										<input type="hidden" id="identity" name="identity" value="company" />
									</div>
