					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
						<tbody>
							...
							<tr>
								...
								<td align="left"><input name="name" type="text" id="name" class="input_border" style="width:200px;" value="${resume.name }" /> <span id="ctl00_ContentPlaceHolder1_RequiredFieldValidator1"
										style="color:Red;font-style:italic;visibility:hidden;">求职者姓名不能为空</span>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td align="left"><input name="homeTown" type="text" id="ctl00_ContentPlaceHolder1_TextBox21" class="input_border" style="width:200px;" value="${resume.homeTown }" />
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td align="left">
									<select name="disabilityPart" id="ctl00_ContentPlaceHolder1_DropDownList7" class="select_border">
										<c:forEach items="${params }" var="p">
