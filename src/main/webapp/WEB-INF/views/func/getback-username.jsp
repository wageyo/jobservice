	                          		...
	                          		<table style="width:100%;line-height:50px;">
	                          			...
	                          			<tr>
	                          				<td colspan="2" style="text-align:center;">
	                          					<input type="button" onclick="getBack('username');" value=" 发 送 " style="border-top: 0px;
border-left: 0px;
border-right: 2px solid rgb(113, 113, 230);
border-bottom: 2px solid rgb(113, 113, 230);
padding: 3px 12px;
font-size: 15px;"/>
	                          				</td>
	                          			</tr>
