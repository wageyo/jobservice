							...
							<table>
								...
								<tbody>
									...
									<tr>
										...
										<td colspan="3">
											<div class="btn-group" >
												<c:if test="${obj.birth != '' && obj.birth != null }">
											...
											<div class="btn-group" >
												<c:if test="${obj.birth != '' && obj.birth != null }">
													<c:set var="day">${fn:substring(obj.birth,5,7) }</c:set>
												</c:if>
									...
									<tr>
										...
										<td colspan="3">
											<div class="btn-group" >
												<button class="btn" id="areaName1" name="areaName1">${obj.hukou.name }</button> 
												<input type="hidden" id="areaValue1" name="areaValue1" value="${obj.hukou.code }"/>
												<button data-toggle="dropdown" class="btn dropdown-toggle"><span class="caret"></span></button>
								...
								<tbody>
									...
									<tr>
										...
										<td colspan="3">
											<div class="btn-group" >
												<button class="btn" id="jcName1" name="jcName1">${obj.desireJob.name }</button> 
												<input type="hidden" id="jcValue1" name="jcValue1" value="${obj.desireJob.code }"/>
												<button data-toggle="dropdown" class="btn dropdown-toggle"><span class="caret"></span></button>
									...
									<tr>
										...
										<td colspan="3">
											<div class="btn-group" >
												<button class="btn" id="desireAddressName1" name="desireAddressName1">${obj.desireAddress.name }</button> 
												<input type="hidden" id="desireAddressValue1" name="desireAddressValue1" value="${obj.desireAddress.code }"/>
												<button data-toggle="dropdown" class="btn dropdown-toggle"><span class="caret"></span></button>
									...
									<tr>
										<td colspan="4" class="warning">
											...
											<span style="float:right;">
												 ...
												 <!-- 添加新建工作经历触发按钮 -->
												 <a href="#modal-container-addwe" role="button" class="btn btn-info" data-toggle="modal">新增</a>
												 <!-- 新建工作经历弹出框    开始-->
												 <div id="modal-container-addwe" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
													...
													<div class="modal-body">
														<table>
															<tr>
																...
																<td>
																	<input id="companyNameAdd" name="companyNameAdd" value="就职公司" type="text" />
																</td>
																<td>
																	&nbsp;
																</td>
																<td>
																	<input id="workTimeAdd" name="workTimeAdd" value="在职时间" type="text" />
																</td>
															</tr>
															<tr>
																<td>
																...
																<td>
																	<input id="jobNameAdd" name="jobNameAdd" value="所在岗位" type="text" />
																</td>
																<td>
																	&nbsp;
																</td>
																<td>
																	<input id="leaveReasonAdd" name="leaveReasonAdd" value="离职原因" type="text" />
																</td>
															</tr>
															<tr>
																<td>
																...
																<td colspan="3">
																	<textarea id="jobContentAdd" name="jobContentAdd"rows="5" style="width: 456px;">工作成绩/内容等等...</textarea>
																</td>
															</tr>
														</table>
													</div>
													<div class="modal-footer">
														 ...
														 <button class="btn btn-primary" onclick="saveWorkExperience();">保存</button>
													</div>
												</div>
												<!-- 新建工作经历弹出框    结束-->
											...
											<tr style="border-top: 1px solid rgb(110, 170, 168);">
												...
												<td>
													...
													<div class="btn-group" style="float:right;">
														<button class="btn" id="btnWorkExperience">操作</button> 
														<button data-toggle="dropdown" class="btn dropdown-toggle"><span class="caret"></span></button>
														<ul class="dropdown-menu">
															<li>
																<a href="javascript:delWorkExperience('${we.id }');">删除</a>
															</li>
															<li>
																<a href="#modal-container-editwe${i.index + 1 }" role="button" data-toggle="modal">编辑</a>
															</li>
														</ul>
													</div>
													 <!-- 编辑工作经历弹出框    开始-->
													 <div id="modal-container-editwe${i.index + 1 }" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
														<div class="modal-header">
															 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
															<h3 id="myModalLabel">
																编辑工作经历
														...
														<div class="modal-body">
															<table>
																<tr>
																	...
																	<td>
																		<input id="companyName${i.index + 1 }" name="companyName" value="${we.companyName }" type="text" />
																	</td>
																	<td>
																		&nbsp;
																	</td>
																	<td>
																		<input id="workTime${i.index + 1 }" name="workTime" value="${we.workTime }" type="text" />
																	</td>
																</tr>
																<tr>
																	<td>
																	...
																	<td>
																		<input id="jobName${i.index + 1 }" name="jobName" value="${we.jobName }" type="text" />
																	</td>
																	<td>
																		&nbsp;
																	</td>
																	<td>
																		<input id="leaveReason${i.index + 1 }" name="leaveReason" value="${we.leaveReason }" type="text" />
																	</td>
																</tr>
																<tr>
																	<td>
																	...
																	<td colspan="3">
																		<textarea id="jobContent${i.index + 1 }" name="jobContent"rows="5" style="width: 456px;">${we.jobContent }</textarea>
																	</td>
																</tr>
															</table>
														</div>
														<div class="modal-footer">
															 <button class="btn" data-dismiss="modal" aria-hidden="true">关闭</button> 
															 <button class="btn btn-primary" onclick="updateWorkExperience('${we.id}','${i.index + 1 }');">保存</button>
														</div>
													</div>
													<!-- 编辑工作经历弹出框    结束-->
												</td>
								...
								<thead>
									<tr>
										<td colspan="4" class="warning">
											...
											<span style="float:right;">
												<!-- 添加新建 测评办理情况 触发按钮 -->
												 <a href="#modal-container-addum" role="button" class="btn btn-info" data-toggle="modal">新增</a>
												 <!-- 新建 测评办理情况 弹出框    开始-->
												 <div id="modal-container-addum" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
													<div class="modal-header">
														 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
														<h3 id="myModalLabel">
															添加职业测评情况
													...
													<div class="modal-body">
														<table>
															<tr>
																<td style="width:30%;">
																	<input id="timeAdd" name="companyNameAdd" value="时间" type="text" style="width:100%;" />
																</td>
																<td>
																	<input id="contentAdd" name="contentAdd" value="办理情况" type="text" style="width:100%;" />
																</td>
															</tr>
														</table>
													</div>
													<div class="modal-footer">
														 <button class="btn" data-dismiss="modal" aria-hidden="true">关闭</button> 
														 <button class="btn btn-primary" onclick="saveUnempManage();">保存</button>
													</div>
												</div>
												<!-- 新建 测评办理情况 弹出框    结束-->
											</span>
										...
										<c:forEach items="${obj.unempManageList }" var="um" varStatus="i">
											<tr>
												...
												<td colspan="3">
													...
													<div class="btn-group"  style="float:right;width:18%;">
														<button class="btn" id="btnWorkExperience">操作</button> 
														<button data-toggle="dropdown" class="btn dropdown-toggle"><span class="caret"></span></button>
														<ul class="dropdown-menu">
															<li>
																<a href="javascript:delUnempManage('${um.id }');">删除</a>
															</li>
															<li>
																<a href="#modal-container-editum${i.index + 1 }" role="button" data-toggle="modal">编辑</a>
															</li>
														</ul>
													</div>
													
													 <!-- 编辑 职业测评情况 弹出框    开始-->
													 <div id="modal-container-editum${i.index + 1 }" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
														<div class="modal-header">
															 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
															<h3 id="myModalLabel">
																编辑职业测评情况
														...
														<div class="modal-body">
															<table>
																<tr>
																	<td style="width:30%;">
																		<input id="time${i.index + 1 }" name="time${i.index + 1 }" value="${um.time }" type="text" style="width:100%;"  />
																	</td>
																	<td>
																		<input id="content${i.index + 1 }" name="content${i.index + 1 }" value="${um.content }" type="text" style="width:100%;"  />
																	</td>
																</tr>
															</table>
														</div>
														<div class="modal-footer">
															 <button class="btn" data-dismiss="modal" aria-hidden="true">关闭</button> 
															 <button class="btn btn-primary" onclick="updateUnempManage('${um.id}','${i.index + 1 }');">保存</button>
														</div>
													</div>
													<!-- 编辑 职业测评情况 弹出框    结束-->
