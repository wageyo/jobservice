								...
								<tbody>
									<tr>
										<td style="width:100px;">
											<input type="hidden" id="newsEditType" value="update" />
									...
									<tr>
										...
										<td>
											<input name="domainName" type="text" value="${obj.domainName }" title="域名" id="domainName"/>
										</td>
										<td>
											<input name="ip" type="text" value="${obj.ip }" title="ip" id="ip"/>
										</td>
										<td>
											&nbsp;
										</td>
