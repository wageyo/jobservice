					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
						<tbody>
							<tr>
								...
								<td align="left"><input name="name" type="text" value="${company.name }" id="name" class="input_border" style="width:200px;">  <span id="ctl00_ContentPlaceHolder1_RequiredFieldValidator1"
