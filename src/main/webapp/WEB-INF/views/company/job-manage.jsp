                        ...
                        <div style="width: 780px;" class="contraction" id="ModelOneID">
                            <div class="contractiontop">
                                ...
                                <div class="contractiontoptext">
                                    <span class="spanFirst">当前位置:</span><span class="spanSecond">企业管理中心 &gt;&gt; 职位管理 &gt;&gt; 已发布职位</span></div>
                                    			...
                                    			<tr class="TheaderBg">
                                   				...
                                   				<c:forEach items="${jobList }" var="job" varStatus="i">
													<tr>
														...
														<td>${i.index + 1 }</td>
														<td><a href="${contextPath }/job/getOneForShow?id=${job.id}">${job.name }</a>
														</td>
														...
														<td>
															<a href="${contextPath }/secure/job/update?id=${job.id}">修改</a>&nbsp;&nbsp; <a href="javascript:void(0);" onclick="deletejob(${job.id},'${job.name }')">删除</a>
														</td>
													</tr>
												</c:forEach>
                                   			</tbody>
