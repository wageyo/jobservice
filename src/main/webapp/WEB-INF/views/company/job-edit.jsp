...
<body>
	...
	<div class="w988 ptb10 center">
		...
		<div class="Air">
			<form action="${contextPath }/secure/job/update" method="post">
						...
						<tr valign="top">
							<td>
								<table border="0" cellspacing="0" cellpadding="0" class="table_boder" align="center">
									<tbody>
										<tr>
											<td class="uu1" align="left" colspan="2"><b> <span id="ctl00_ContentPlaceHolder1_Label1">职位管理&gt;&gt;编辑职位</span>
											</b></td>
										</tr>
									</tbody>
								</table></td>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
						<tbody>
							...
							<tr>
								...
								<td align="left"><input name="name" type="text" value="${job.name }" id="name" class="input_border" style="width:200px;"> <span
										id="ctl00_ContentPlaceHolder1_RequiredFieldValidator1" style="color:Red;font-style:italic;visibility:hidden;">职位名称</span> <input type="hidden" name="id" value="${job.id }" />
								</td>
							</tr>
							<tr>
								<td align="right" class="line35"><span class="red line35_r">*</span><b> 招聘人数 ：</b></td>
								<td align="left"><input name="hireNumber" type="text" value="${job.hireNumber }" id="hireNumber" class="input_border" style="width:200px;"> <span
							...
							<tr>
								...
								<td align="left" class="ptb5"><textarea name="description" rows="2" cols="20" id="ctl00_ContentPlaceHolder1_TextBox9" class="input_border" style="height:150px;width:450px;">${job.description }</textarea>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td align="left"><input name="contactPerson" value="${job.contactPerson }" type="text" id="contactPerson" class="input_border" style="width:200px;">
								</td>
							</tr>
							<tr>
								<td align="right" class="line35"><span class="red line35_r">*</span><b> 联系电话 ：</b>
								</td>
								<td align="left"><input name="contactTel" value="${job.contactTel }" type="text" id="contactTel" class="input_border" style="width:200px;"> <span
							...
							<tr>
								...
								<td align="left"><input name="contactEmail" value="${job.contactEmail }" type="text" id="ctl00_ContentPlaceHolder1_TextBox2" class="input_border" style="width:200px;">
								</td>
							</tr>
							<tr>
