                        ...
                        <div style="width: 780px;" class="contraction" id="ModelOneID">
                            <div class="contractiontop">
                                ...
                                <div class="contractiontoptext">
                                    <span class="spanFirst">当前位置:</span><span class="spanSecond">企业管理中心 &gt;&gt; 应聘信息 &gt;&gt; 简历收件箱</span></div>
                                    			...
                                    			<tr class="TheaderBg">
                                   				...
                                   				<c:forEach items="${recordList }" var="record" varStatus="i">
													<tr>
														...
														<td>${i.index + 1 }</td>
														<td><a href="${contextPath }/resume/getOneForShow?id=${record.rID}">${record.rName }</a></td>
														<td>${record.rGender }</td>
														<td>${record.rAge }</td>
														<td>${record.rEducation }</td>
														<td>${record.rMajor }</td>
													</tr>
												</c:forEach>
                                   			</tbody>
