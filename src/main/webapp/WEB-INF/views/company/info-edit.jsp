...
<body>
	...
	<div class="w988 ptb10 center">
		...
		<div class="Air">
			...
			<form action="${contextPath }/secure/company/update" method="post" onSubmit="return company_check();">
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
						<tbody>
							<tr>
								...
								<td align="left"><input name="name" type="text" value="${company.name }" id="name" class="input_border" style="width:200px;"> <input type="hidden"
										name="id" value="${company.id }" /> <span id="ctl00_ContentPlaceHolder1_RequiredFieldValidator1"
										style="display:inline-block;color:Red;border-width:1px;border-style:solid;font-style:italic;visibility:hidden;">企业名称不能为空</span> <br>
								</td>
							</tr>
							<tr>
								<td align="right" class="line35" width="120"><span class="red line35_r">*</span><b> 法人代表 ： </b></td>
								<td align="left"><input name="corporateRepresentative" value="${company.corporateRepresentative }" type="text" id="corporateRepresentative" class="input_border"
									style="width:200px;"> <span id="ctl00_ContentPlaceHolder1_RequiredFieldValidator1"
										style="display:inline-block;color:Red;border-width:1px;border-style:solid;font-style:italic;visibility:hidden;">企业名称不能为空</span> <br>
								</td>
							</tr>
							<tr>
								<td align="right" class="line35" width="120"><b> 组织机构代码 ： </b></td>
								<td align="left"><input name="organizationCode" value="${company.organizationCode }" type="text" id="organizationCode" class="input_border" style="width:200px;">
										<span id="ctl00_ContentPlaceHolder1_RequiredFieldValidator1" style="display:inline-block;color:Red;border-width:1px;border-style:solid;font-style:italic;visibility:hidden;">企业名称不能为空</span> <br>
								</td>
							</tr>
							<tr>
								<td align="right" class="line35" width="120"><span class="red line35_r">*</span><b> 工商登记号码 ： </b></td>
								<td align="left"><input name="commercialCode" value="${company.commercialCode }" type="text" id="commercialCode" class="input_border" style="width:200px;"> <span
							...
							<tr>
								...
								<td align="left"><input name="taxCode" type="text" value="${company.taxCode }" id="taxCode" class="input_border" style="width:200px;"> <span
										id="ctl00_ContentPlaceHolder1_RequiredFieldValidator1" style="display:inline-block;color:Red;border-width:1px;border-style:solid;font-style:italic;visibility:hidden;">企业名称不能为空</span> <br>
								</td>
							</tr>
							<tr>
								<td align="right" class="line35" width="120"><b> 社保登记证号 ： </b></td>
								<td align="left"><input name="socialSecurityCode" value="${company.socialSecurityCode }" type="text" id="socialSecurityCode" class="input_border" style="width:200px;">
										<span id="ctl00_ContentPlaceHolder1_RequiredFieldValidator1" style="display:inline-block;color:Red;border-width:1px;border-style:solid;font-style:italic;visibility:hidden;">企业名称不能为空</span> <br>
								</td>
							</tr>
							<tr>
								<td align="right" class="line35" width="120"><b> 网站ID ： </b></td>
								<td align="left"><input name="webSiteId" type="text" value="${company.webSiteId }" id="ctl00_ContentPlaceHolder1_TextBox1" class="input_border" style="width:200px;"> <span
										id="ctl00_ContentPlaceHolder1_RequiredFieldValidator1" style="display:inline-block;color:Red;border-width:1px;border-style:solid;font-style:italic;visibility:hidden;">企业名称不能为空</span> <br>
								</td>
							</tr>
							<tr>
								<td align="right" class="line35" width="120"><b> 市劳网号 ： </b></td>
								<td align="left"><input name="laoWangCode" type="text" value="${company.laoWangCode }" id="ctl00_ContentPlaceHolder1_TextBox1" class="input_border" style="width:200px;"> <span
										id="ctl00_ContentPlaceHolder1_RequiredFieldValidator1" style="display:inline-block;color:Red;border-width:1px;border-style:solid;font-style:italic;visibility:hidden;">企业名称不能为空</span> <br>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td align="left"><select name="businessScope.id" id="ctl00_ContentPlaceHolder1_DropDownList1" class="select_border">
							...
							<tr>
								...
								<td align="left"><textarea name="introduction" rows="2" cols="20" id="ctl00_ContentPlaceHolder1_TextBox19" class="input_border"
										style="height:80px;width:450px;font-size: 12px; padding: 6px;">${company.introduction }</textarea></td>
							</tr>
							...
							<tr>
								...
								<td align="left"><input name="telephone" type="text" value="${company.telephone }" id="telephone" class="input_border" style="width:200px;">
								</td>
							</tr>
							<tr>
								<td align="right" class="line35"><span class="red line35_r">*</span><b>联系人 ：</b></td>
								<td align="left"><input name="contactPerson" type="text" value="${company.contactPerson }" id="contactPerson" class="input_border" style="width:200px;">
								</td>
							</tr>
							<tr>
								<td align="right" class="line35"><b>联系部门 ：</b></td>
								<td align="left"><input name="contactDept" type="text" value="${company.contactDept }" id="ctl00_ContentPlaceHolder1_TextBox10" class="input_border" style="width:200px;">
								</td>
							</tr>
							<tr>
								<td align="right" class="line35"><b>传真 ：</b></td>
								<td align="left"><input name="fax" type="text" value="${company.fax }" id="ctl00_ContentPlaceHolder1_TextBox5" class="input_border" style="width:200px;">
								</td>
							</tr>
							<tr>
								<td align="right" class="line35"><b>邮箱 ：</b></td>
								<td align="left"><input name="email" type="text" value="${company.email }" id="ctl00_ContentPlaceHolder1_TextBox2" class="input_border" style="width:200px;">
								</td>
							</tr>
							<tr>
								<td align="right" class="line35"><b>公司地址 ：</b></td>
								<td align="left"><input name="address" type="text" value="${company.address }" id="ctl00_ContentPlaceHolder1_TextBox2" class="input_border" style="width:200px;">
								</td>
							</tr>
							<tr>
								<td align="left" colspan="2" class="line35" style="padding-left: 130px;"><input type="submit" name="ctl00$ContentPlaceHolder1$Button1" value="更  新" onclick=""
