...
(function($) {
	...
	$.Chart = $.extend($.Painter, {
		...
		create : function(_,shell) {
			...
			H.push("<p>您的浏览器版本不支持此控件的显示。请使用<a href='http://w.x.baidu.com/alading/anquan_soft_down_ub/14744'>谷歌</a>, <a href='http://w.x.baidu.com/alading/anquan_soft_down_ub/11843'>火狐<a>, <a href='http://down.360safe.com/se/360se7.1.1.560.exe'>360浏览器</a>急速模式或<a href='http://www.baidu.com/link?url=TmmkNNHA9Xnh1zetWeq5Z5B7jIJDlhRzZWYBepKSgEyKwDwB0xjSAdCS_Bdybv5y9uESo69d13eLFbNT_m-Apx_bq4Fl-6O0y5-_UN4SsG_'>IE9</a>以上浏览器.</p></canvas>");
			H.push("</div>");
